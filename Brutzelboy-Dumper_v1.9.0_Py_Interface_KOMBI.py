    ...
    if (userInput == '0'):
        ...
        # https://gbdk-2020.github.io/gbdk-2020/docs/api/docs_rombanking_mbcs.html
                    ...
                    if (cartridgeType == 0):
                        ...
                        print('ROM+MBC5+RAM+BATT or EMS MULTICARD\n')
                    #elif ((cartridgeType == 27) and (regions == 225)): #0x1B, regions used before assignment! other fix needed
                    #    print('EMS MULTICARD\n')
        ...
        #------------
            ...
            #-------------------
                ...
                print('\nGoing to write to RAM (save) from ' + str(gameTitle) + str(suffix_sav)+'\n')
                ...
                if (userInput2 == 'y'):
                    ...
                    data += bytes(b'') # missing  value atm
                    if data:
